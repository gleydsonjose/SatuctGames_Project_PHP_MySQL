<?php
    ...
    $games = $dados->BuscarGameLancamento($game_inicial_pagina, $games_por_pagina);
    ...
    // Passando todos os jogos que são lançamentos para o array criado acima.
    foreach($todos_games_bd as $chave=>$games_bd){
        if($games_bd['lancamento'] == '1'){
            $games_lancamento[$chave] = $games_bd;
        }
    }

    // Definindo o número de páginas
    $num_paginas = ceil(count($games_lancamento)/$games_por_pagina);
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <title>Lançamentos - SatuctGames</title>
</head>
<body>
    <!-- HEADER -->
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-preto menu-loja py-0">
                    ...
                    <div class="collapse navbar-collapse w-100" id="menu-navegacao">
                        <ul class="navbar-nav mt-lg-0 mt-2">
                            ...
                            <li class="nav-item">
                                <a href="lancamentos.php" class="nav-link ativo">Lançamentos<span class="sr-only">(atual)</span></a>
                            </li>
                        </ul>
        ...
        <div class="row">
            <div class="col-12">
                <div class="col-12 d-flex mt-3 mb-5 pb-5">
                    <img src="imagens/banner-lancamentos.png?<?= time() ?>" alt="Banner promoções" class="img-fluid mx-auto" style="box-shadow: 0px 0px 1px 0px #292c2f;">
                </div>
                            ...
                            <div class="col-12-lista-games d-flex flex-nowrap bg-cinza-2 px-0 mx-auto rounded">
                                ...
                                <div class="d-flex flex-row flex-wrap pl-3 pr-0">
                                    <div class="flex-row align-self-center mt-2 w-100">
                                        <h6 class="text-cinza" style="font-size: 11pt; text-align: justify;"><?= $g['nome_game'] ?></h6>
                                    </div>
                                </div>
