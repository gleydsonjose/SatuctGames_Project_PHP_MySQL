<?php
    ...
    $games = $dados->BuscarGameCategoria($game_inicial_pagina, $games_por_pagina, "Aventura");
    ...
    foreach($todos_games_bd as $chave=>$games_bd){
        if($games_bd['categoria'] == 'Aventura'){
...
<head>
    ...
    <title>Aventura - SatuctGames</title>
</head>
<body>
    <!-- HEADER -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="col-12 d-flex mt-3 mb-5 pb-5">
                    <img src="imagens/banner-aventura.png?<?= time() ?>" alt="Banner jogos de aventura" class="img-fluid mx-auto" style="box-shadow: 0px 0px 1px 0px #292c2f;">
                </div>

                <div class="row mb-5 pt-5 pb-3" style="-ms-flex-wrap: nowrap !important; flex-wrap: nowrap !important;">
                    <div class="col-12">
                        <span class="text-preto ml-2 pl-2 border-left-titulo-preto" style="font-size: 15pt;">GAMES DE AVENTURA</span>
                    </div>
                </div>
