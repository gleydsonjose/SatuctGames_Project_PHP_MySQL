...
$game_info = $dados->BuscarDadosGame("game-wolfenstein-youngblood");
...
<head>
    ...
    <title>Wolfenstein Youngblood - SatuctGames</title>
</head>
<body>
    <!-- HEADER -->
                            ...
                            if(isset($_SESSION["id_administrador"]) || isset($_SESSION["id_moderador"])){
                                ...
                                if(!isset($_SESSION["id_administrador"]) && $a["pk_id_usuario"] == 1){
                                    ...
                                    <form method="POST" action="../scripts/excluir-avaliacao.php">
                                        <input type="radio" class="form-check-input d-none" name="nome_game" value="game-wolfenstein-youngblood" checked>
