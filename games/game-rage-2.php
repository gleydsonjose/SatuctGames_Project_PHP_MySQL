...
$game_info = $dados->BuscarDadosGame("game-rage-2");
...
<head>
    ...
    <title>Rage 2 - SatuctGames</title>
</head>
<body>
    <!-- HEADER -->
                            ...
                            if(isset($_SESSION["id_administrador"]) || isset($_SESSION["id_moderador"])){
                                ...
                                if(!isset($_SESSION["id_administrador"]) && $a["pk_id_usuario"] == 1){
                                    ...
                                    <form method="POST" action="../scripts/excluir-avaliacao.php">
                                        <input type="radio" class="form-check-input d-none" name="nome_game" value="game-rage-2" checked>
