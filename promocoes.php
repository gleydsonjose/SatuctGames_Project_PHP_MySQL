<?php
    ...
    $games = $dados->BuscarGamePromocao($game_inicial_pagina, $games_por_pagina);
    ...
    // Passando todos os jogos que estão em promoção para o array criado acima.
    foreach($todos_games_bd as $chave=>$games_bd){
        if($games_bd['promocao'] == '1'){
            $games_promocao[$chave] = $games_bd;
        }
    }

    // Definindo o número de páginas
    $num_paginas = ceil(count($games_promocao)/$games_por_pagina);
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <title>Promoções - SatuctGames</title>
</head>
<body>
    <!-- HEADER -->
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-preto menu-loja py-0">
                    ...
                    <div class="collapse navbar-collapse w-100" id="menu-navegacao">
                        <ul class="navbar-nav mt-lg-0 mt-2">
                            ...
                            <li class="nav-item">
                                <a href="promocoes.php" class="nav-link ativo">Promoções<span class="sr-only">(atual)</span></a>
                            </li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="col-12 d-flex mt-3 mb-5 pb-5">
                    <img src="imagens/banner-promocoes.png?<?= time() ?>" alt="Banner promoções" class="img-fluid mx-auto" style="box-shadow: 0px 0px 1px 0px #292c2f;">
                </div>
