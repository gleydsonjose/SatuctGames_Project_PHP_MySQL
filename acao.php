<?php
    ...
    $games = $dados->BuscarGameCategoria($game_inicial_pagina, $games_por_pagina, "Ação");
        ...
        <div class="row">
            <div class="col-12">
                <div class="col-12 d-flex mt-3 mb-5 pb-5">
                    <img src="imagens/banner-acao.png?<?= time() ?>" alt="Banner jogos de ação" class="img-fluid mx-auto" style="box-shadow: 0px 0px 1px 0px #292c2f;">
                </div>

                <div class="row mb-5 pt-5 pb-3" style="-ms-flex-wrap: nowrap !important; flex-wrap: nowrap !important;">
                    <div class="col-12">
                        <span class="text-preto ml-2 pl-2 border-left-titulo-preto" style="font-size: 15pt;">GAMES DE AÇÃO</span>
                    </div>
                </div>
