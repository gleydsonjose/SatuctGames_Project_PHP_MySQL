<?php
    ...
    $games_promocao = $dados->BuscarGamePromocao(0, 8);
    ...
    $games_lancamento = $dados->BuscarGameLancamento(0, 8);
...
<head>
    ...
    <title>Início - SatuctGames</title>
</head>
<body>
    <!-- HEADER -->
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-preto menu-loja py-0">
                    ...
                    <div class="collapse navbar-collapse w-100" id="menu-navegacao">
                        <ul class="navbar-nav mt-lg-0 mt-2">
                            <li class="nav-item">
                                <a href="index.php" class="nav-link ativo">Inicio<span class="sr-only">(atual)</span></a>
                            </li>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="d-flex mb-5 pb-5">
                <img src="imagens/banner-pagina-principal.png?<?= time() ?>" alt="Banner página principal" class="img-fluid mx-auto shadow-sm">
            </div>

            <div class="col-12">
                <div class="row mb-5 pt-5 pb-3" style="-ms-flex-wrap: nowrap !important; flex-wrap: nowrap !important;">
                    <div class="col-12">
                        <span class="text-preto ml-2 pl-2 border-left-titulo-preto" style="font-size: 15pt;">PROMOÇÕES</span>
                    </div>
                </div>

                <div class="row">
          <?php if(count($games_promocao) > 0){ ?>
              <?php foreach($games_promocao as $gp){ ?>
                    <div class="col-md-3 col-6 text-center mb-5 pb-3">
                        <img src="<?= $gp['imagem'] ?>" alt="Imagem de <?= $gp['nome_game'] ?>" class="img-fluid rounded" style="width: 200px; height: 200px; filter: grayscale(20%);">
                        <div class="text-break mx-4">
                            <h6 class="text-preto my-3"><?= $gp['nome_game'] ?></h6>
                            <h6 class="text-muted" style="font-size: 12pt;">De R$<?= $gp['preco_antigo'] ?></h6>
                            <h6 class="text-preto preco-oficial mb-3" style="font-size: 14pt;">Por R$<?= $gp['preco_atual'] ?></h6>
                            <a href="games/<?= $gp['nome_url_pagina'] ?>.php" class="btn-ver-detalhes"><i class="fas fa-plus pr-2"></i>Ver detalhes</a>
                        </div>
                    </div>
              <?php } 
                } ?>

                    <a href="promocoes.php" class="btn-ver-detalhes mt-2 mx-auto"><i class="far fa-circle pr-2"></i>Ver mais...</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid mt-5 pt-5 pb-5">
        <div class="row pb-5">
            <div class="col-12">
                <div class="row mb-5 pt-5 pb-3" style="-ms-flex-wrap: nowrap !important; flex-wrap: nowrap !important;">
                    <div class="col-12">
                        <span class="text-preto ml-2 pl-2 border-left-titulo-preto" style="font-size: 15pt;">LANÇAMENTOS</span>
                    </div>
                </div>

                <div class="row">
              <?php if(count($games_lancamento) > 0){ ?>
                  <?php foreach($games_lancamento as $gl){ ?>
                        <div class="col-md-3 col-6 text-center mb-5 pb-3">
                            <img src="<?= $gl['imagem'] ?>" alt="Imagem de <?= $gl['nome_game'] ?>" class="img-fluid rounded" style="width: 200px; height: 200px; filter: grayscale(20%);">
                            <div class="text-break mx-4">
                                <h6 class="text-preto my-3"><?= $gl['nome_game'] ?></h6>
                                <h6 class="text-preto preco-oficial mb-3" style="font-size: 14pt;">Por R$<?= $gl['preco_atual'] ?></h6>
                                <a href="games/<?= $gl['nome_url_pagina'] ?>.php" class="btn-ver-detalhes"><i class="fas fa-plus pr-2"></i>Ver detalhes</a>
                            </div>
                        </div>
                  <?php } 
                    } ?>

                        <a href="lancamentos.php" class="btn-ver-detalhes mt-2 mx-auto"><i class="far fa-circle pr-2"></i>Ver mais...</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid bg-preto mt-5">
        <div class="row">
            <div class="col-6 mt-3">
                ...
                <a href="faleconosco.php" class="btn-ver-detalhes my-0 ml-1" style="font-size: 11pt;">Envie mensagens por email para nós <i class="fas fa-arrow-left"></i></a>
            </div>
